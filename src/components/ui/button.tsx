...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-dark shadow-blue hover:shadow-elegant hover:scale-[1.02] active:scale-[0.98]",
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary-accent hover:shadow-md",
        ...
        gradient: "bg-gradient-to-r from-primary to-primary-dark text-primary-foreground hover:shadow-blue hover:scale-[1.02] active:scale-[0.98]",
        glass: "bg-white/10 backdrop-blur-md border border-white/20 text-primary hover:bg-white/20 hover:shadow-blue",
      },
      size: {
