...
import { GraduationCap, Eye, EyeOff, HelpCircle } from "lucide-react";
import { View, Hide, Mail, Lock, User, Achievement, Help } from "grommet-icons";
        ...
        <CardHeader className="space-y-4 text-center">
          ...
          <div>
            ...
            <CardDescription className="text-base">
              Join International Covenant College Management System
            </CardDescription>
          </div>
        </CardHeader>
